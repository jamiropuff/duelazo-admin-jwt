...
<body class="hold-transition login-page bg-duelazo">

  <div class="login-box">
    <!-- /.login-logo -->
    <div class="card card-outline card-primary">
      <div class="card-header text-center bg-light-primary">
        <a href="./"><img src="<?= base_url() ?>/images/logo-d.png" class="img-fluid"></a>
      </div>
      <div class="card-body">
        <p class="login-box-msg">Inicia tu sesión</p>

        <div id="error_login" class="text-center c-red"></div>
